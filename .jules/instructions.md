# Jules Coding & Integration Guidelines — All-in-bank
...
## 📋 Repo Profile: business-app

Business apps (All-in-bank, All-in-pne, IT_Support) — โต + ปลอดภัย
...
### Cooldown
- แต่ละ session ห่างกันอย่างน้อย **5 ชั่วโมง**
- สูงสุด **7 sessions/วัน** สำหรับ repo นี้
